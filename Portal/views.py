...
from .models import CommunicationLanguage
from .models import Task, Project, UsersSkill
...
def send_simple_message(reciever,subject,text):
    ...
    print(">>",subject)
    print(">>",text)
    fromaddr = "shreyashpawar0000@gmail.com"
    toaddr = []
    
    toaddr.append(reciever)
    toaddr[0].encode('utf-8')
    msg = MIMEMultipart()
    ...
    text = msg.as_string()
    send_mail(subject,text,fromaddr ,toaddr, auth_user='shreyashpawar0000@gmail.com', auth_password='DiPlOmA@qwe')
    print(x,"sent mail")
